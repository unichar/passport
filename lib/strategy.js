...
/**
 * Retrieve user profile from UniChar.
 *
 * This function constructs a normalized profile, with the following properties:
 *
 *   - `provider`         always set to `unichar`
 *   - `id`               the user's UniChar ID
 *   - `username`         the user's UniChar username
 *   - `displayName`      the user's full name
 *   - `profileUrl`       the URL of the profile for the user on UniChar
